      ...
      <group rotation={[0, 0, 0]}>
        ...
        <group position={[0, 0, -frameDepth / 2]}>
          ...
          <mesh>
            ...
            >
              Transportation Building: Renowned Chicago architect Louis Sullivan was responsible for the imaginative design of the Transportation Building.
            </Text>
          </mesh>
...
function VideoExhibit4() {
  ...
  useEffect(() => {
    ...
    video.src = "/data/Transportation-Building.mp4";
  ...
  return (
    <div className="exhibit-container">
      ...
      <div className="exhibit-content">
        <p className="exhibit-description">Transporation Building</p>
