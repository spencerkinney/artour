      ...
      <group rotation={[0, 0, 0]}>
        ...
        <group position={[0, 0, -frameDepth / 2]}>
          ...
          <mesh>
            ...
            >
              The Javanese band could be heard while walking the grounds offering a soundtrack for the sights.
            </Text>
          </mesh>
  ...
  return (
    <div className="exhibit-container">
      ...
      <div className="exhibit-content">
        <p className="exhibit-description">Javanese Band</p>
