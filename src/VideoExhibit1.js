      ...
      <group rotation={[0, 0, 0]}>
        ...
        <group position={[0, 0, -frameDepth / 2]}>
          ...
          <mesh>
            ...
            >
              The Grand Basin was the main body of water at the Columbian Exposition seen here lit by electric light.
            </Text>
          </mesh>
...
function VideoExhibit1() {
  ...
  useEffect(() => {
    ...
    video.src = "/data/Grand-Basin-Night.mp4";
  ...
  return (
    <div className="exhibit-container">
      ...
      <div className="exhibit-content">
        <p className="exhibit-description">Grand Basin at Night</p>
